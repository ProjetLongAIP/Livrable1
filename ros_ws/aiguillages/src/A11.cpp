...
// Reception et envoi des navettes
	SendShuttle = nh.advertise<std_msgs::Int32>("/IOShuttle/A11_P12", 10);
	ReceiveShuttle = nh.subscribe("/IOShuttle/A10_A11", 10, &A11::newShuttleCallback, this);
...
void A11::SwitchSensorCallback(const std_msgs::Int32::ConstPtr& msg)
{
	...
	if (Aig_D == 1) {
		std_msgs::Int32 Maxime; 
		Maxime.data = ListShuttles.front();
		ListShuttles.pop_front();
		SendShuttle.publish(Maxime);
	}
}
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////Commande Aiguillage/////////////////////////////////
...
void A11::newShuttleCallback (const std_msgs::Int32::ConstPtr& msg) {
