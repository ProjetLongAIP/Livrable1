...
void Robot2::SendPositionCallback(const std_msgs::Int32::ConstPtr& msg)
{
	...
	{
		ROS_INFO("Position predefinie %d pour le robot 2 non atteinte",pos);
...
void Robot2::SendJointsCallback(const robot::RobotJoints::ConstPtr& msg)
{
...
void Robot2::init(ros::NodeHandle noeud)
{
	...
	//Subscribers
	planifSendPosition = noeud.subscribe("/commande/Simulation/SendPositionRobot2",1,&Robot2::SendPositionCallback,this);

	planifSendJoints = noeud.subscribe("/commande/Simulation/SendJointsRobot2",1,&Robot2::SendJointsCallback,this);
	
 	planifFermerPince = noeud.subscribe("/commande/Simulation/FermerPinceRobot2",1,&Robot2::FermerPinceCallback,this);

	planifOuvrirPince = noeud.subscribe("/commande/Simulation/OuvrirPinceRobot2",1,&Robot2::OuvrirPinceCallback,this);
	
	planifDescendreBras = noeud.subscribe("/commande/Simulation/DescendreBras2",1,&Robot2::DescendreBrasCallback,this);

	planifMonterBras = noeud.subscribe("/commande/Simulation/MonterBras2",1,&Robot2::MonterBrasCallback,this);
