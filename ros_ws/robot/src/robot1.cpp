...
void Robot1::SendPositionCallback(const std_msgs::Int32::ConstPtr& msg)
{
	...
	{
		ROS_INFO("Position predefinie %d pour le robot 1 non atteinte",pos);
...
void Robot1::SendJointsCallback(const robot::RobotJoints::ConstPtr& msg)
{
...
void Robot1::init(ros::NodeHandle noeud)
{
	...
	//Subscribers
	planifSendPosition = noeud.subscribe("/commande/Simulation/SendPositionRobot1",1,&Robot1::SendPositionCallback,this);

	planifSendJoints = noeud.subscribe("/commande/Simulation/SendJointsRobot1",1,&Robot1::SendJointsCallback,this);
	
 	planifFermerPince = noeud.subscribe("/commande/Simulation/FermerPinceRobot1",1,&Robot1::FermerPinceCallback,this);

	planifOuvrirPince = noeud.subscribe("/commande/Simulation/OuvrirPinceRobot1",1,&Robot1::OuvrirPinceCallback,this);
	
	planifDescendreBras = noeud.subscribe("/commande/Simulation/DescendreBras1",1,&Robot1::DescendreBrasCallback,this);

	planifMonterBras = noeud.subscribe("/commande/Simulation/MonterBras1",1,&Robot1::MonterBrasCallback,this);


	//Publishers
	pub_pince = noeud.advertise<std_msgs::Int32>("/robot/cmdPinceRobot1", 1);
	
	pub_retourCommande = noeud.advertise<std_msgs::Int32>("/commande/Simulation/retourCommande1", 1);
