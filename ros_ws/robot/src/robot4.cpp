...
void Robot4::SendPositionCallback(const std_msgs::Int32::ConstPtr& msg)
{
	...
	{
		ROS_INFO("Position predefinie %d pour le robot 4 non atteinte",pos);
...
void Robot4::SendJointsCallback(const robot::RobotJoints::ConstPtr& msg)
{
...
void Robot4::init(ros::NodeHandle noeud)
{
	...
	//Subscribers
	planifSendPosition = noeud.subscribe("/commande/Simulation/SendPositionRobot4",1,&Robot4::SendPositionCallback,this);

	planifSendJoints = noeud.subscribe("/commande/Simulation/SendJointsRobot4",1,&Robot4::SendJointsCallback,this);
	
 	planifFermerPince = noeud.subscribe("/commande/Simulation/FermerPinceRobot4",1,&Robot4::FermerPinceCallback,this);

	planifOuvrirPince = noeud.subscribe("/commande/Simulation/OuvrirPinceRobot4",1,&Robot4::OuvrirPinceCallback,this);
	
	planifDescendreBras = noeud.subscribe("/commande/Simulation/DescendreBras4",1,&Robot4::DescendreBrasCallback,this);

	planifMonterBras = noeud.subscribe("/commande/Simulation/MonterBras4",1,&Robot4::MonterBrasCallback,this);


	//Publishers
	pub_pince = noeud.advertise<std_msgs::Int32>("/robot/cmdPinceRobot4", 1);

	pub_retourCommande = noeud.advertise<std_msgs::Int32>("/commande/Simulation/retourCommande4", 1);
